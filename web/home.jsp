                    ...
                    <div class="top-bar">
                        ...
                        <div class="navbar-nav">
                            ...
                            <div class="navbar-register">
                                <a href=${empty sessionScope.account.full_name ? '/Account/login' : '#'}>${empty sessionScope.account.full_name ? "Đăng Nhập" : sessionScope.account.full_name }</a>
                            </div>
                            <div class="navbar-shopcart">
